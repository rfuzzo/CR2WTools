...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CSkyTransformEntity : CEntity
{
...
[REDProp("transformType")]
public ESkyTransformType TransformType { get; set;}

[REDProp("alignToPlayer")]
public bool AlignToPlayer { get; set;}

[REDProp("onlyYaw")]
public bool OnlyYaw { get; set;}
