...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CNewNPC : CActor
{
...
[REDProp("suppressBroadcastingReactions")]
public bool SuppressBroadcastingReactions { get; set;}

[REDProp("berserkTime")]
public EngineTime BerserkTime { get; set;}
