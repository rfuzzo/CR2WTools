...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CBgNpcTriggerComponent : CTriggerAreaComponent
{
...
[REDProp("actions")]
public Array<Ptr<IBgNpcTriggerAction>> Actions { get; set;}
