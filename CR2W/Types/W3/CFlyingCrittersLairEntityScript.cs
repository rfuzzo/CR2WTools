...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CFlyingCrittersLairEntityScript : CFlyingCrittersLairEntity
{
...
[REDProp("defeatedStateFact")]
public string DefeatedStateFact { get; set;}

[REDProp("defeatedStateFactValue")]
public int DefeatedStateFactValue { get; set;}

[REDProp("lairDisabledAtStartup")]
public bool LairDisabledAtStartup { get; set;}

[REDProp("scriptInput")]
public Ptr<CFlyingSwarmScriptInput> ScriptInput { get; set;}

[REDProp("cellMapResourceFile")]
public Soft<CSwarmCellMap> CellMapResourceFile { get; set;}

[REDProp("cellMapCellSize")]
public float CellMapCellSize { get; set;}
