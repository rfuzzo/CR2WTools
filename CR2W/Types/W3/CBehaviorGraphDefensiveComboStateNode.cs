...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CBehaviorGraphDefensiveComboStateNode : CBehaviorGraphComboStateNode
{
...
[REDProp("varLevel")]
public CName VarLevel { get; set;}

[REDProp("varParry")]
public CName VarParry { get; set;}

[REDProp("defaultHits")]
public Array<CName> DefaultHits { get; set;}
