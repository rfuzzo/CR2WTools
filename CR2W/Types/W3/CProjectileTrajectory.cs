...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CProjectileTrajectory : CGameplayEntity
{
...
[REDProp("animatedOffset")]
public Vector AnimatedOffset { get; set;}

[REDProp("animatedTimeMultiplier")]
public float AnimatedTimeMultiplier { get; set;}

[REDProp("bounceOfVelocityPreserve")]
public float BounceOfVelocityPreserve { get; set;}

[REDProp("overlapAccuracy")]
public float OverlapAccuracy { get; set;}

[REDProp("doWaterLevelTest")]
public bool DoWaterLevelTest { get; set;}

[REDProp("waterTestAccuracy")]
public float WaterTestAccuracy { get; set;}

[REDProp("caster")]
public Handle<CEntity> Caster { get; set;}

[REDProp("realCaster")]
public Handle<CEntity> RealCaster { get; set;}
