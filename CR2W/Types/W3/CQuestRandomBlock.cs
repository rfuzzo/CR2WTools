...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CQuestRandomBlock : CQuestGraphBlock
{
...
[REDProp("randomOutputs")]
public Array<CName> RandomOutputs { get; set;}
