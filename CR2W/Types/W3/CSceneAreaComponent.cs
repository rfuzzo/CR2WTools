...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CSceneAreaComponent : CTriggerAreaComponent
{
...
[REDProp("sceneSelectionMode")]
public ESceneSelectionMode SceneSelectionMode { get; set;}

[REDProp("scenesPriority")]
public EArbitratorPriorities ScenesPriority { get; set;}

[REDProp("intervalBetweenScenes")]
public float IntervalBetweenScenes { get; set;}

[REDProp("maxConcurrentScenes")]
public uint MaxConcurrentScenes { get; set;}

[REDProp("scenes")]
public Array<CScenesTableEntry> Scenes { get; set;}

[REDProp("actorsType")]
public ESceneActorType ActorsType { get; set;}
