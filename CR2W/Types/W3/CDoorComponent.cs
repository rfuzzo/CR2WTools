...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CDoorComponent : CInteractionComponent
{
...
[REDProp("initialState")]
public EDoorState InitialState { get; set;}

[REDProp("isTrapdoor")]
public bool IsTrapdoor { get; set;}

[REDProp("doorsEnebled")]
public bool DoorsEnebled { get; set;}
