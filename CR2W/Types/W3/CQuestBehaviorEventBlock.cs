...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CQuestBehaviorEventBlock : CQuestGraphBlock
{
...
[REDProp("events")]
public Array<Ptr<SQuestBehaviorEvent>> Events { get; set;}
