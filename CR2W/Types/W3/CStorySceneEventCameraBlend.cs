...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CStorySceneEventCameraBlend : CStorySceneEventDuration
{
...
[REDProp("blendKeys")]
public Array<SStorySceneCameraBlendKey> BlendKeys { get; set;}

[REDProp("interpolationType")]
public ECameraInterpolation InterpolationType { get; set;}
