...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CTeleporter : CEntity
{
...
[REDProp("destinationNodesTags")]
public TagList DestinationNodesTags { get; set;}

[REDProp("teleportedActorsTags")]
public TagList TeleportedActorsTags { get; set;}
