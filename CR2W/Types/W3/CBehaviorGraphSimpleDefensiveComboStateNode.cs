...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CBehaviorGraphSimpleDefensiveComboStateNode : CBehaviorGraphComboStateNode
{
...
[REDProp("varHitTime")]
public CName VarHitTime { get; set;}

[REDProp("varHitLevel")]
public CName VarHitLevel { get; set;}

[REDProp("varElemEnum")]
public CName VarElemEnum { get; set;}

[REDProp("varParry")]
public CName VarParry { get; set;}

[REDProp("enum")]
public CName Enum { get; set;}

[REDProp("animElems")]
public Array<SBehaviorComboElem> AnimElems { get; set;}
