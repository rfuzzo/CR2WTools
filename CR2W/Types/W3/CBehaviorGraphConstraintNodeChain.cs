...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CBehaviorGraphConstraintNodeChain : CBehaviorGraphConstraintNode
{
...
[REDProp("startBone")]
public string StartBone { get; set;}

[REDProp("endBone")]
public string EndBone { get; set;}

[REDProp("solverSteps")]
public int SolverSteps { get; set;}

[REDProp("forwardEndBoneDir")]
public EAxis ForwardEndBoneDir { get; set;}
