...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CStorySceneEventAdditiveAnimation : CStorySceneEventAnimation
{
...
[REDProp("convertToAdditive")]
public bool ConvertToAdditive { get; set;}
