...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CWitcherSword : CItemEntity
{
...
[REDProp("timeToDespawn")]
public float TimeToDespawn { get; set;}

[REDProp("reportToScript")]
public bool ReportToScript { get; set;}

[REDProp("swordType")]
public EWitcherSwordType SwordType { get; set;}
