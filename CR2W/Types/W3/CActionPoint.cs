...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CActionPoint : CGameplayEntity
{
...
[REDProp("events")]
public Array<SEntityActionsRouterEntry> Events { get; set;}

[REDProp("actionBreakable")]
public bool ActionBreakable { get; set;}

[REDProp("overrideActionBreakableInComponent")]
public bool OverrideActionBreakableInComponent { get; set;}
