...
public UInt32 SupportDepth { get; set;}

[REDProp("useAssetDefinedSupport")]
public bool UseAssetDefinedSupport { get; set;}

[REDProp("debrisDepth")]
public Int32 DebrisDepth { get; set;}

[REDProp("essentialDepth")]
public UInt32 EssentialDepth { get; set;}
...
public UInt32 MinimumFractureDepth { get; set;}
...
public Int32 ImpactDamageDefaultDepth { get; set;}
...
[REDProp("eventOnDestruction", 2,0)]
