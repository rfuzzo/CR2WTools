...
namespace CR2W.Types.W3
{
	...
	public class CR4InteriorAreaComponent : CTriggerAreaComponent
	{
		...
		[REDProp("entranceTag")]
		public CName EntranceTag { get; set;}

		[REDProp("texture")]
		public string Texture { get; set;}

		[REDProp("isDarkPlace")]
		public bool IsDarkPlace { get; set;}

		[REDProp("allowHorseInThisInterior")]
		public bool AllowHorseInThisInterior { get; set;}

		[REDProp("movementLock")]
		public EPlayerMovementLockType MovementLock { get; set;}
