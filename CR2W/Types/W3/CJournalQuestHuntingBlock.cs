...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CJournalQuestHuntingBlock : CQuestGraphBlock
{
...
[REDProp("questHuntingTag")]
public Handle<CJournalPath> QuestHuntingTag { get; set;}

[REDProp("creatureHuntingClue")]
public Handle<CJournalPath> CreatureHuntingClue { get; set;}
