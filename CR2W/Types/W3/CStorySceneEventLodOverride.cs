...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CStorySceneEventLodOverride : CStorySceneEvent
{
...
[REDProp("actorsByTag")]
public TagList ActorsByTag { get; set;}

[REDProp("forceHighestLod")]
public bool ForceHighestLod { get; set;}

[REDProp("disableAutoHide")]
public bool DisableAutoHide { get; set;}
