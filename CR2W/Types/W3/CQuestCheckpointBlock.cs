...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CQuestCheckpointBlock : CQuestGraphBlock
{
...
[REDProp("enableSaving")]
public bool EnableSaving { get; set;}

[REDProp("ignoreSaveLocks")]
public bool IgnoreSaveLocks { get; set;}
