...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CBehaviorGraphStatePelvisTransitionNode : CBehaviorGraphStateTransitionBlendNode
{
...
public string PelvisBoneName { get; set;}

[REDProp("pelvisDirectionFwdLS")]
public EAxis PelvisDirectionFwdLS { get; set;}

[REDProp("usePelvisBlendMethod")]
public bool UsePelvisBlendMethod { get; set;}
