...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CBehTreeNodeFleeReactionDefinition : CBehTreeNodeAtomicMoveToDefinition
{
...
public CBehTreeValFloat FleeDistance { get; set;}

[REDProp("surrenderDistance")]
public CBehTreeValFloat SurrenderDistance { get; set;}

[REDProp("queryRadiusRatio")]
public float QueryRadiusRatio { get; set;}
