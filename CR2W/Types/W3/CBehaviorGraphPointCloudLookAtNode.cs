...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CBehaviorGraphPointCloudLookAtNode : CBehaviorGraphBaseNode
{
...
/*[REDProp("Lower body part bones")]
public Array<SBehaviorGraphBoneInfo> Lower body part bones { get; set;}*/
