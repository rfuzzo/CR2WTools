...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CQuestChangeWorldBlock : CQuestGraphBlock
{
...
[REDProp("newWorld")]
public int NewWorld { get; set;}

[REDProp("loadingMovieName")]
public string LoadingMovieName { get; set;}

[REDProp("targetTag")]
public TagList TargetTag { get; set;}
