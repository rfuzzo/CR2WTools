...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CBehaviorGraphAnimationSelAdditiveSlotNode : CBehaviorGraphAnimationAdditiveSlotNode
{
...
[REDProp("cachedBaseInputNode")]
public Ptr<CBehaviorGraphNode> CachedBaseInputNode { get; set;}

[REDProp("startEvtName")]
public CName StartEvtName { get; set;}

[REDProp("stopEvtName")]
public CName StopEvtName { get; set;}

[REDProp("additiveType")]
public EAdditiveType AdditiveType { get; set;}

[REDProp("cachedBaseAnimInputNode")]
public Ptr<CBehaviorGraphNode> CachedBaseAnimInputNode { get; set;}

[REDProp("firstBone")]
public string FirstBone { get; set;}

[REDProp("lastBone")]
public string LastBone { get; set;}
