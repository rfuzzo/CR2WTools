...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CVirtualContainerEntity : CGameplayEntity
{
...
[REDProp("characterState")]
public Array<byte> CharacterState { get; set;}
