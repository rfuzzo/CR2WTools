...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CBehaviorGraphLookAtUsingEmbeddedAnimationsNode : CBehaviorGraphLookAtUsingAnimationsCommonBaseNode
{
...
/*[REDProp("Default pair")]
public SLookAtAnimationPairDefinition Default pair { get; set;}

[REDProp("Input based pairs")]
public Array<SLookAtAnimationPairInputBasedDefinition> Input based pairs { get; set;}*/
