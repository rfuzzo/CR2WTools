...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CBehTreeNodeConditionExternalToggleDefinition : CBehTreeNodeConditionDefinition
{
...
[REDProp("switchName")]
public CName SwitchName { get; set;}

[REDProp("initialValue")]
public CBehTreeValBool InitialValue { get; set;}
