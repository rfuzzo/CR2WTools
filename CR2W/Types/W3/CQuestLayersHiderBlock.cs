...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CQuestLayersHiderBlock : CQuestGraphBlock
{
...
[REDProp("layersToShow")]
public Array<string> LayersToShow { get; set;}

[REDProp("layersToHide")]
public Array<string> LayersToHide { get; set;}

[REDProp("syncOperation")]
public bool SyncOperation { get; set;}
