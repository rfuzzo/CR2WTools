...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CBehaviorGraphFlowConnectionNode : CBehaviorGraphStateNode
{
...
[REDProp("stateID")]
public CName StateID { get; set;}

[REDProp("animNode")]
public Ptr<CBehaviorGraphAnimationNode> AnimNode { get; set;}
