...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CCurveEntity : CEntity
{
...
[REDProp("curveComponent")]
public Ptr<CCurveComponent> CurveComponent { get; set;}

[REDProp("controlPointEntities")]
public Array<Ptr<CCurveControlPointEntity>> ControlPointEntities { get; set;}
