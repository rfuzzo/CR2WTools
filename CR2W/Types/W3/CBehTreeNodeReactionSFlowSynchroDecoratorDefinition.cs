...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CBehTreeNodeReactionSFlowSynchroDecoratorDefinition : CBehTreeNodeConditionDefinition
{
...
[REDProp("allowedRole")]
public CName AllowedRole { get; set;}

[REDProp("isBlocikng")]
public bool IsBlocikng { get; set;}
