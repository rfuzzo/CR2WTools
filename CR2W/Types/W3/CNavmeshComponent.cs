...
{
[TypeConverter(typeof(ExpandableObjectConverter))]public class CNavmeshComponent : CAreaComponent
{
...
[REDProp("navmeshParams")]
public SNavmeshParams NavmeshParams { get; set;}

[REDProp("pathlibAreaId")]
public UInt16 PathlibAreaId { get; set;}

[REDProp("sharedFileName")]
public string SharedFileName { get; set;}

[REDProp("generationRootPoints")]
public Array<Vector> GenerationRootPoints { get; set;}
