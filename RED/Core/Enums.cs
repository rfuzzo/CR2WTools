...
namespace RED.Core
{
    ...
    [Flags] public enum EDrawableFlags
    {
        DF_IsVisible = 1,
    ...
    [Flags] public enum ELightChannel
    {
        LC_Characters = 1,
        LC_Interactive = 2,
        LC_Custom0 = 4,
    }
    [Flags] public enum EEntityStaticFlags
    {
        ESF_Streamed = 1,
        ESF_NoCompExtract = 2,
    ...
    [Flags] public enum ETriggerChannel
    {
        TC_Default = 1,
        TC_Player = 2,
        TC_Camera = 4,
